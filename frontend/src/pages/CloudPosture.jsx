...
const COMPLIANCE_CHECKS = [
  ...
  { id: 'enc-dynamo', category: 'Encryption', name: 'DynamoDB Encryption', status: 'pass', detail: 'Table uses AWS-managed CMK encryption at rest' },
  { id: 'enc-transit', category: 'Encryption', name: 'Data In-Transit (TLS)', status: 'pass', detail: 'API Gateway enforces HTTPS; all Lambda invocations use TLS' },
  { id: 'log-cw', category: 'Logging', name: 'CloudWatch Logging', status: 'pass', detail: 'All Lambda functions have log groups with 30-day retention' },
  ...
  { id: 'iam-least', category: 'IAM', name: 'Least Privilege Roles', status: 'pass', detail: '7/8 roles follow least-privilege; 1 role flagged for review' },
...
const COST_ESTIMATES = [
  ...
  { service: 'Lambda', icon: '⚡', monthly: '$0.45', detail: '~50K invocations/month across 5 functions' },
  { service: 'API Gateway', icon: '🌐', monthly: '$0.35', detail: 'HTTP API, ~100K requests/month' },
  { service: 'DynamoDB', icon: '📊', monthly: '$1.25', detail: 'On-demand capacity, ~500K read/write units' },
  { service: 'S3', icon: '📦', monthly: '$0.85', detail: '~15 GB logs + Athena results' },
  { service: 'CloudWatch', icon: '📈', monthly: '$2.10', detail: 'Log groups, metrics, alarms, dashboards' },
      ...
      <Section title="AWS Services Inventory" icon="☁️" badge={`${totalResources} resources`}>
        <div className="posture__services-grid">
          {[
            ...
            { icon: '⚡', name: 'Lambda Functions', count: serviceCount.lambda, detail: 'Ingest, API, Chat, Query, Fleet' },
            { icon: '📦', name: 'S3 Buckets', count: serviceCount.s3, detail: 'Logs, Athena, Scripts' },
            { icon: '📊', name: 'DynamoDB Tables', count: serviceCount.dynamo, detail: 'suricata-events' },
            { icon: '🌐', name: 'API Gateway', count: serviceCount.apiGw, detail: 'HTTP API v2' },
            ...
            { icon: '📈', name: 'CloudWatch', count: serviceCount.cloudwatch, detail: 'Alarms, dashboards, log groups' },
